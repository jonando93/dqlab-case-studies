# -*- coding: utf-8 -*-
"""
Created on Wed Sep 30 16:22:27 2020
...
# [6.1] TRAINING MODEL: FIT - LOGISTIC REGRESSION
## Call the classifier
logreg = LogisticRegression()
## Fit the classifier to the training data  
logreg = logreg.fit(X_train,y_train)

# [6.2] TRAINING MODEL: PREDICT - LOGISTIC REGRESSION
## Training Model: Predict 
y_pred = logreg.predict(X_test)
print(y_pred.shape)

# [7] EVALUATING MODEL PERFORMANCE - LOGISTIC REGRESSION
## Evaluate Model Performance
print('\nTraining Accuracy :', logreg.score(X_train, y_train))  
